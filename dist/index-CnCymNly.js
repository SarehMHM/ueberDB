...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, visitedProfiles = {}) => {
    ...
    if (!options.roleAssumer) {
        const { getDefaultRoleAssumer } = await Promise.resolve().then(function(){return require('./index-Bd5q4XLz.js')});
...
const resolveProcessCredentials = async (options, profile) => Promise.resolve().then(function(){return require('./index-D4HLeudv.js')}).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
})());const resolveSsoCredentials = async (profile, options = {}) => {
    const { fromSSO } = await Promise.resolve().then(function(){return require('./index-MLD5DEUf.js')});
    return fromSSO({
        profile,
...
const resolveStaticCredentials = (profile, options) => {
    ...
    typeof arg.role_arn === "string" &&
    ["undefined", "string"].indexOf(typeof arg.role_session_name) > -1;
const resolveWebIdentityCredentials = async (profile, options) => Promise.resolve().then(function(){return require('./index-DB389FTK.js')}).then(({ fromTokenFile }) => fromTokenFile({
