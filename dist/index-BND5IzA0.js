...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, visitedProfiles = {}) => {
    ...
    if (!options.roleAssumer) {
        const { getDefaultRoleAssumer } = await Promise.resolve().then(function(){return require('./index-Cgor3qRl.js')});
...
const resolveProcessCredentials = async (options, profile) => Promise.resolve().then(function(){return require('./index-KsdPQjdU.js')}).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
})());const resolveSsoCredentials = async (profile, options = {}) => {
    const { fromSSO } = await Promise.resolve().then(function(){return require('./index-QPPmz-P1.js')});
    return fromSSO({
        profile,
...
const resolveStaticCredentials = (profile, options) => {
    ...
    typeof arg.role_arn === "string" &&
    ["undefined", "string"].indexOf(typeof arg.role_session_name) > -1;
const resolveWebIdentityCredentials = async (profile, options) => Promise.resolve().then(function(){return require('./index-CyK3kUEj.js')}).then(({ fromTokenFile }) => fromTokenFile({
